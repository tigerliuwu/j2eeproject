...
<script type="text/javascript" src="./js/selectDateTime.js"></script>
...

	{
		...
		document.forms[0].action = 'expCertificateBoxModify1Action.do';
...
<body>
<html:form action="/expCertificateBoxModify1Action">
		...
		<table width="98%" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
				...
				<td valign="top">
					...
					<strong><font color="#040466">&nbsp;&nbsp;Certificate Box&nbsp;->&nbsp;Update</font>	</strong>
