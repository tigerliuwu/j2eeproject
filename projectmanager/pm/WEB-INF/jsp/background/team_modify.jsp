...
<form action="backModifyTeamUserAction.do">
	<input type="hidden" name="userId" value='<bean:write name="userRoles" property="user.id" />'/>
	...
	<br>
		...
		<tr>
			...
			<td valign="top">
				...
				<strong><font color="#040466">项目成员维护&nbsp;-->&nbsp;编辑成员角色</font></strong>          
				<br><br>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>项目名称：</strong>
				...
				<div align=center>
				成员姓名：<bean:write name="userRoles" property="user.userName" />
				</div>
				<br>
...
<tr onMouseOut="this.style.backgroundColor='#FFFFFF'" onMouseOver="this.style.backgroundColor='#DDDDDD'" >
	...
	<td align="center">
		<input type="checkbox" name="checkbox_<bean:write name="role" property="id" />"
			<logic:iterate id="roleId" name="userRoles" property="roleSet" >	
				<logic:equal name="role" property="id" value="<%=roleId.toString()%>" >
					checked
				</logic:equal>		
	    	</logic:iterate> 
