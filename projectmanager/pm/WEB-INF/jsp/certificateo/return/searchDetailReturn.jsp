...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="impCertificateOModify1PreAction.do?certificateId=<bean:write name="o" property="certificateId" />">Edit</a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="#" onclick="before_delete('<bean:write name="o" property="certificateId" />','<gdc:write name="o" property="currentStatus" labelvalue="CertificateStatus"/>')">Delete</a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="impCertificateOPreviewPreAction.do?certificateId=<bean:write name="o" property="certificateId" />">Preview</a>
<br>
<br>
