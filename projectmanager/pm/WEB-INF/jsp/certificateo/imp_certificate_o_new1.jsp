...
<script type="text/javascript" src="./js/selectDateTime.js"></script>
...

	{
		...
		document.forms[0].action = 'impCertificateONew1Action.do';
...

	{
		...
		document.forms[0].action = 'impCertificateONew2PreAction.do';
...
<body>
<html:form action="/impCertificateONew1Action">
		...
		<table width="98%" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
				...
				<td valign="top">
					...
					<strong><font color="#040466">&nbsp;&nbsp;Certificate O&nbsp;->&nbsp;New</font>	</strong>
					...
					<table width="100%" border="1" align="center" cellpadding="2"
						...
						<tr height="25">
							...
							<td bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;
								<html:text name="impCertificateOBasicForm" property="remainedTimes" 
								 styleClass="inputline" size="40" />
							</td>
						</tr>
