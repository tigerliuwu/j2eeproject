...
<script type="text/javascript" src="./js/selectDateTime.js"></script>
...

	{
		...
		document.forms[0].action = 'impCertificateBatteryModify1Action.do';
...

	{
		...
		document.forms[0].action = 'impCertificateBatteryModify2PreAction.do';
...
<body>
<html:form action="/impCertificateBatteryModify1Action">
		...
		<table width="98%" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
				...
				<td valign="top">
					...
					<strong><font color="#040466">&nbsp;&nbsp;Certificate Battery&nbsp;->&nbsp;Update</font>	</strong>
					...
					<tr height="25">
						...
						<tr height="25">
						<td align="right" bgcolor="#E9EBEF" Name="证书状态">Certificate Status:</td>
						  <td>&nbsp;&nbsp;&nbsp;&nbsp;
							  <html:select name="impCertificateBatteryBasicForm" property="currentStatus">
						...
						<tr>
							...
							<td colspan="4" bgcolor="#FFFFFF" align="middle" height="50">
