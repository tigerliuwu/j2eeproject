...
<td align="right" bgcolor="#E9EBEF" width="25%">Registration No.:</td>
  ...
  <td align="right" bgcolor="#E9EBEF" width="25%">Certificate Status:</td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="impCertificateBatteryModify1PreAction.do?certificateBatteryId=<bean:write name="battery" property="certificateBatteryId" />">Edit</a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="#" onclick="before_delete('<bean:write name="battery" property="certificateBatteryId" />','<gdc:write name="battery" property="currentStatus" labelvalue="CertificateStatus"/>')">Delete</a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="impCertificateBatteryPreview1PreAction.do?certificateBatteryId=<bean:write name="battery" property="certificateBatteryId" />">Preview</a>
<br>
<br>
